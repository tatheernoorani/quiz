...
defined( 'ABSPATH' ) || exit;
	...
	class PIE_Admin_Settings {
		 ...
		 * Settings page.
		 *
		 * Handles the display of the main pie-forms settings page in admin.
		 */
						...
						?><tr valign="top" class="<?php echo esc_attr( implode( ' ', $visibility_class ) ); ?>">
							...
							<td class="forminp forminp-<?php echo esc_attr( sanitize_title( $value['type'] ) ); ?>">
								<input
									...
									/><?php echo esc_html( $value['suffix'] ); ?> <?php echo '</p><i>'.$tooltip_html.'</i></p>'; // phpcs:ignore WordPress.Security.EscapeOutput.O	utputNotEscaped ?>
							</td>
						</tr>
						<?php
						break;
