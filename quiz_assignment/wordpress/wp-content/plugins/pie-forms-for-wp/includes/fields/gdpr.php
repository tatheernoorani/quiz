...
if(get_option('pf_gdpr_options') === 'yes'){
    class PIE_Fields_GDPR extends PIE_Abstracts_Fields {
        ...
        public function field_preview( $field ) {
            ...
            echo '<label class="pie-gdpr-label">'.$label.'</label>';
        ...
        public function field_display( $field, $field_atts, $form_data ) {
            ...
            echo '<label class="pie-gdpr-agreement-label" for="'.$primary['id'].'">'.$label.'</label></div>';
        }
    }
}
