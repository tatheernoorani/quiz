...
abstract class PIE_Abstracts_Marketing {
		...
		public function __construct() {
				add_filter( 'pie_forms_marketing_tabs_array', array( $this, 'add_settings_page' ), 20 );
		...
		public function output() {
			...
			PIE_Admin_Settings::output_fields( $settings );
		}
