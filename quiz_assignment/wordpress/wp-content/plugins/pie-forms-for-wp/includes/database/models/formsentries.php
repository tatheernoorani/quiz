...
/**
 * Class PIE_Database_Models_FormsEntries
 */
final class PIE_Database_Models_FormsEntries
{
	...
	public function update_status( $entry_id, $status = 'publish' ) {
		...
		$entry = $this->pf_get_entry( $entry_id );
...
} // End PIE_Database_Models_FormsEntries
