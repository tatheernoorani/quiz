...
if ( ! class_exists( 'PIE_Admin_Builder_Page', false ) ) :

	/**
	 * PIE_Admin_Builder_Page Class.
	 */
	 class PIE_Admin_Builder_Page {
		...
		public function __construct() {
			...
			$this->form_data = is_object( $this->form ) ? Pie_Forms()->core()->pf_decode( wp_unslash($this->form->form_data) ) : array();
			// Init hooks.
			$this->init_hooks();
