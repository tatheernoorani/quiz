...
function fca_qc_render_marketing_metabox( $post ) {
	...
	<ul>
		...
		<li><div class="dashicons dashicons-yes"></div> <?php _e( 'Assign Points With Weighted Quizzes', 'quiz-cat' ); ?></li>
		...
		<li><div class="dashicons dashicons-yes"></div> <?php _e( 'Modify Your Quiz Appearance', 'quiz-cat' ); ?></li>
