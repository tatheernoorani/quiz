...
function fca_qc_maybe_add_custom_styles( $post_id ) {
	...
	// ANSWER
	$answer_font_color = empty( $quiz_appearance['answer_font_color'] ) ? '#151515' : $quiz_appearance['answer_font_color'];
	$answer_hover_color = empty( $quiz_appearance['answer_hover_color'] ) ? '#8dc8bf' : $quiz_appearance['answer_hover_color'];
	$answer_background_color = empty( $quiz_appearance['answer_background_color'] ) ? '#dbdbdb' : $quiz_appearance['answer_background_color'];
	$answer_border_thickness = empty( $quiz_appearance['answer_border_thickness'] ) ? '0' : $quiz_appearance['answer_border_thickness'];
	$answer_border_color = empty( $quiz_appearance['answer_border_color'] ) ? '#dbdbdb' : $quiz_appearance['answer_border_color'];
	...
	ob_start(); ?>	
		...
		<style>
			...
			<?php echo "#fca_qc_quiz_$post_id" ?>.fca_qc_quiz button.fca_qc_next_question {
				color: <?php echo $next_button_font_color ?>;
				border: <?php echo $next_button_border_color . ' 2px solid' ?>;
			}

			<?php echo "#fca_qc_quiz_$post_id" ?>.fca_qc_quiz button.fca_qc_next_question:hover {
				background-color: <?php echo $next_button_hover_color ?>;
			}
			...
			<?php echo "#fca_qc_quiz_$post_id" ?>.fca_qc_quiz div.fca_qc_answer_div {
				background-color: <?php echo $answer_background_color ?>;
				border: <?php echo $answer_border_color . ' ' . $answer_border_thickness . 'px solid' ?>;
			}
			...
			<?php echo "#fca_qc_quiz_$post_id" ?>.fca_qc_quiz span.fca_qc_answer_span {
				color: <?php echo $answer_font_color ?>;
			}
